                    ...
                    <table class="table" border="1px">
                        ...
                        <tr>
                            ...
                            <td width="150px">
                                ...
                                <button type="button" remove-id="1" class="btn btn-danger btn-remove"
                        ...
                        <tr>
                            ...
                            <td width="150px">
                                <a href="" class="btn btn-primary">Update</a>
                                <button type="button" remove-id="2" class="btn btn-danger btn-remove"
                                    data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    Remove
                                </button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="150px">
                                <a href="" class="btn btn-primary">Update</a>
                                <button type="button" remove-id="3" class="btn btn-danger btn-remove"
                                    data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    Remove
                                </button>
                            </td>
